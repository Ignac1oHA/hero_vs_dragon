# This is Ignacio Henríquez homework. Thanks for reading.
...
# add code on this line
    ...
    hero_hp = int(hero_hp - dragon_attack)
...
# here goes the if
    ...
    if hero_hp <= 0:
        ...
        break
        excepthero_hp >= 1
        print("Hero is still alive, do not take this for granted!")
...
# add code on this line
    ...
    if dragon_hp <= 0:
        ...
        break
        excetdragon_hp >= 0
        print("the dragon is still alive and eager to eat some hobbits.")
